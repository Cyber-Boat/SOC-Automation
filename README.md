...
All public IPs have been anonymized:
•	<WAZUH_IP>
•	<THEHIVE_IP>
...
•	Telemetry included EventID 7 (ImageLoaded), process command lines, system metadata.
...
3.	Pulling SHA256 hash values
4.	Sending data to TheHive as an alert
Workflow includes:
•	Webhook trigger
•	JSON parser
...
This provides a hands-free automated pipeline for Level 1 SOC triage.
...
1.	Sysmon detects Mimikatz
2.	Wazuh Agent forwards logs
3.	Wazuh Manager parses logs, triggers custom rules
4.	Wazuh Integration sends alerts to Shuffle
5.	Shuffle Workflow enriches and forwards to TheHive
6.	TheHive Case is created for analyst investigation
